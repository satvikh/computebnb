  ...
  return (
    <section className="rounded-lg border border-white/10 bg-[#0b0d0c]/90 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-md border border-white/10 px-2 py-1 text-xs text-zinc-500">human-readable</span>
      </div>
      <div className="mt-4 max-h-[360px] space-y-2 overflow-hidden font-mono text-xs">
        ...
        {!logs.length ? (
          <div className="rounded-md border border-white/5 bg-white/[0.03] px-3 py-2 text-zinc-500">
            No events yet. Start the worker to see success and failure messages here.
          </div>
        ) : null}
      </div>
    </section>
